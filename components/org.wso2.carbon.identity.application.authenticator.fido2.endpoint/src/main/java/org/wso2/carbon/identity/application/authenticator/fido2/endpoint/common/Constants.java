...
public class Constants {
    ...
    public enum ErrorMessages {
        ...
        ERROR_CODE_FETCH_CREDENTIALS_EMPTY_USERNAME("50007", "Error while fetching device metadata.",
                "Username not available in the request."),
        ERROR_CODE_START_REGISTRATION_EMPTY_APP_ID("50008", "Error starting the fido device " +
